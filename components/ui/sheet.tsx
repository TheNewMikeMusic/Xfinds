...
const sheetVariants = cva(
  "fixed z-[100] gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        top: "!fixed !inset-x-0 !top-0 !left-0 !right-0 !bottom-auto border-b data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
        bottom:
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          sheetVariants({ side }),
          isTop && "!top-0 !left-0 !right-0 !bottom-auto",
          className
        )}
        {...props}
      >
